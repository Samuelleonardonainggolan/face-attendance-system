    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50 flex items-center justify-center p-4">
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3 mb-8">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-600 to-teal-500 text-white font-bold text-2xl shadow-lg">
                H
              </div>
              <div>
                <h1 className="text-3xl font-bold text-gray-900">HRIS System</h1>
                <p className="text-sm text-gray-600">Face Attendance System</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">
                    Manajemen Karyawan Terpadu
                  </h3>
                  <p className="text-sm text-gray-600">
                    Kelola data karyawan, absensi, dan penggajian dalam satu platform
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">
                    Absensi Wajah & Geofencing
                  </h3>
                  <p className="text-sm text-gray-600">
                    Teknologi pengenalan wajah dan lokasi untuk absensi akurat
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Monitoring kehadiran dan performa karyawan secara real-time
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 pt-8 border-t border-gray-200">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Akurasi Absensi</p>
            </div>
            <div>
      ...
      <div className="lg:hidden absolute top-8 left-1/2 -translate-x-1/2">
        <div className="flex items-center gap-2">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-600 to-teal-500 text-white font-bold text-lg shadow-lg">
            H
          </div>
          <div>
            <h1 className="text-xl font-bold text-gray-900">HRIS System</h1>
          </div>
        </div>
      </div>
    </div>
